export { TEAMS_EAST as _e } from './teamsEast'
export { TEAMS_WEST as _w } from './teamsWest'
export { TEAMS_SOUTH as _s } from './teamsSouth'
export { TEAMS_MIDWEST as _m } from './teamsMidwest'
